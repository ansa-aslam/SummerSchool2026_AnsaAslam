...
> 📖 **How to use this workbook.** Read along and **type every `⌨️` block yourself** in RStudio — don't just watch. First thing each session: **Session > Set Working Directory > To your Input File Location**.
